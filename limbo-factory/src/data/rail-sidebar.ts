...
railSidebarPhases[1] = {
  ...
  subPhases: [
    ...
    { id: "remaining", title: "18 remaining divergence rows still awaiting a decision", status: "pending", note: "See the Full divergence list tab — categories C, F, H, I, J, K, L, M. Category B (dark rail colors) and G (radius) are now fully resolved; 6 rail-specific items (G-1, H-1, K-1, K-2, L-2, M-1) approved once the rail was visually signed off (\u201crail seems right entirely\u201d). D-12 (Panel-actions menu text-size vs. D-5/D-6) was raised and resolved after that sign-off: keep the shared dropdown-menu text-sm convention, no override." },
  ],
}
