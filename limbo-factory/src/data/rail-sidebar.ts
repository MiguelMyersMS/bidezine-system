...
export const proposedDarkRailTokens: ProposedToken[] = [
  ...
  { originName: "darkBorderStrong", proposedVar: "--sidebar-rail-border-strong", usage: "Visible border on the dark rail", originLightHex: "rgba(255,255,255,0.6)", originDarkHex: "#5a6169", proposedLight: "oklch(0.256 0 0)", proposedDark: "oklch(0.254 0 0)" },
...
export const divergenceCategories: DivergenceCategory[] = [
  ...
  },
  {
    ...
    rows: [
      { id: "B-1", what: "darkSurface (rail background)", status: "resolved", detail: "Resolved by Q2: author a dedicated dark-rail token family. The approved candidate is tracked in the Color token lab; Build still needs to write it to tokens/*.tokens.json.", visual: { kind: "color", beforeLabel: "darkSurface (origin)", beforeHexLight: "#1c2024", beforeHexDark: "#111113", afterVar: "--sidebar-rail-surface", afterLabel: "approved new token", afterNote: "Resolved by Q2 and the approved Color token lab candidate." } },
      { id: "B-2", what: "darkHoverBg (hover overlay)", status: "resolved", detail: "Resolved by Q2: add this state to the dedicated dark-rail token family; Build still needs to author it.", visual: { kind: "color", beforeLabel: "darkHoverBg (origin)", beforeHexLight: "rgba(255,255,255,0.10)", beforeHexDark: "#212225", afterNote: "Resolved by Q2 and the approved Color token lab candidate." } },
      ...
      { id: "B-4", what: "darkPressedBg (pressed overlay)", status: "resolved", detail: "Resolved by Q2: add this state to the dedicated dark-rail token family; Build still needs to author it.", visual: { kind: "color", beforeLabel: "darkPressedBg (origin)", beforeHexLight: "rgba(255,255,255,0.15)", beforeHexDark: "#2e3135", afterNote: "Resolved by Q2 and the approved Color token lab candidate." } },
      { id: "B-5", what: "darkBorderStrong (visible border on dark surface)", status: "resolved", detail: "Resolved by Q2: add a stronger dark-rail border token; Build still needs to author it.", visual: { kind: "color", beforeLabel: "darkBorderStrong (origin)", beforeHexLight: "rgba(255,255,255,0.6)", beforeHexDark: "#5a6169", afterVar: "--sidebar-rail-border-strong", afterLabel: "approved new token" } },
