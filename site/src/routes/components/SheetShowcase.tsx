...
const apiRows: ApiRow[] = [
  {
    ...
    default: `"right"`,
    description: "SheetContent: which edge of the viewport the sheet slides in from.",
  },
  {
    prop: "open / defaultOpen",
    type: "boolean",
    description: "Controlled/uncontrolled open state (Radix Dialog prop underneath).",
  },
]
      ...
      <div>
        ...
        <p className="mt-2 text-muted-foreground">
          ...
          <code className="rounded bg-muted px-1 py-0.5 text-sm">
            reference/shadcn-ui/apps/v4/registry/new-york-v4/ui/sheet.tsx
          </code>{" "}
          unchanged.
        </p>
      </div>
