 ...
 * as closely as possible, restructured as an ExampleBrowser.
 */
...
const apiRows: ApiRow[] = [
  {
    ...
    default: `"vertical"`,
    description: "Field: layout direction of the label/control/description.",
  },
  {
    prop: "data-disabled",
    type: "boolean (data attribute)",
    description: "Field: marks the field visually disabled.",
  },
]
