...
const examples: ShowcaseExample[] = [
  {
    ...
    code: `<SidebarProvider className="min-h-[32rem] overflow-hidden rounded-lg border">
  <Sidebar>
    <SidebarHeader>
      <SidebarMenu>
        <SidebarMenuItem>
...
export function SidebarShowcase() {
  return (
    <div className="flex max-w-5xl flex-col gap-8">
      ...
      <ApiReference rows={apiRows1} title="SidebarProvider" />
      <ApiReference rows={apiRows2} title="Sidebar" />
    </div>
  )
}
