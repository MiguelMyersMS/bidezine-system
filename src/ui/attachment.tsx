...
function AttachmentContent({
  ...
  return (
    <div
      ...
      className={cn(
        "max-w-full min-w-0 flex-1 leading-grouped group-data-[orientation=vertical]/attachment:px-1",
        className
      )}
      {...props}
    />
...
function AttachmentDescription({
  ...
  return (
    <span
      ...
      className={cn(
        "mt-0.5 block min-w-0 truncate text-caption text-muted-foreground group-data-[state=error]/attachment:text-destructive/80",
        "max-w-full",
        className
      )}
      {...props}
