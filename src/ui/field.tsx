...
function FieldContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "group/field-content flex flex-1 flex-col gap-1.5 leading-clustered",
        className
      )}
      {...props}
    />
...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "group/field-label peer/field-label flex w-fit gap-2 leading-clustered group-data-[disabled=true]/field:opacity-50",
