 ...
 * Dialog — ORGANISM.
 *
 * Behaviour: borrowed from shadcn/ui (MIT) — Radix `Dialog`, which owns the
 * focus trap, the portal, Escape-to-close, scroll locking, and the
 * aria-modal / labelledby / describedby wiring. This is precisely the class of
 * behaviour ADR-006 says we borrow and never re-solve.
 * See THIRD-PARTY-LICENSES.md.
 *
 * These behaviours must be verified BEHAVIOURALLY (ADR-005), not assumed —
 * that is the point of running this slice through /evidence-pipeline.
 *
